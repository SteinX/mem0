...
admin, they receive `403` from account mutation and API-key management
routes. Use an admin dashboard session or the legacy operator credential for
those control-plane operations.
